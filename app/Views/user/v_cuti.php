        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Leave Page</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                            ...
                            <td>
                                 <div class="table-responsive">
                                      <div class="table table-striped table-hover ">
                                                            <a href="<?= site_url('User/edit_cuti').'/'.$i->id ?>" class="btn btn-outline-primary">
...
<div class="modal fade" id="AdddataCuti" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
      echo form_open('User/save_data_cuti');
      ?>
...
<script>  
  ...
  if (willDelete) {
    <?php
    foreach ($data_cuti as $i) : ?>
    window.location.href = '<?= site_url('User/delete_cuti').'/'.$i->id ?>'
    <?php endforeach ?>
  }
});
  }  
